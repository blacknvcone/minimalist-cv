    ...
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Avatar className="size-28 overflow-hidden">
            <AvatarImage alt={RESUME_DATA.name} src={RESUME_DATA.avatarUrl}  className="object-cover w-full h-full object-top" />
          ...
          {RESUME_DATA.certification.map((certification) => {
            return (
              <Card key={certification.title}>
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-2 text-base">
                    <a href={`tel:${certification.link}`}>
                      <h3 className="font-semibold leading-none">
                        {certification.title}
                      </h3>
                    </a>
                    <div className="text-sm tabular-nums text-gray-500">
                      {certification.date_issue}
                    </div>
                  </div>
                </CardHeader>
